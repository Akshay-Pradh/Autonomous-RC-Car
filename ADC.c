...
void HEXtoBCD(int hex_value){
    ...
    while (hex_value > 999){
        ...
        value = value + 1;
        adc_char[0] = 0x30 + value;     // sets thousands place to ASCII character
    }
    value = 0;
    while (hex_value > 99){
        hex_value = hex_value - 100;
        value = value + 1;
        adc_char[1] = 0x30 + value;     // sets hundreds place to ASCII character
    }
    value = 0;
    while (hex_value > 9){
        hex_value = hex_value - 10;
        value = value + 1;
        adc_char[2] = 0x30 + value;     // sets tens place to ASCII character
    }
    adc_char[3] = 0x30 + hex_value;     // sets ones places to ASCII character
}
//-----------------------------------------------------------------
